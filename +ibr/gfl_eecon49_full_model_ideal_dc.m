...
% Identical to gfl_eecon49_full_model except the DC-source closure, which reverts to the
...
function dev = gfl_eecon49_full_model_ideal_dc(device_id,bus_id,bus_position,bus_ids,V0,params,P_ref,Q_ref)
