...
switch analysis_id
    ...
    case 'ibr'
        ...
        % IEEE 14-bus, 1 SG (bus 1, manual/no-AVR) + 4 GFL IBRs (buses 2,3,6,8):
        % AGSI++ index-driven GFL<->GFM switch on an SG trip and synchronized
        % reclose. Meshed single-area operating point is small-signal stable.
        ieee14_opt = struct('ibr_analysis','full', ...
            't_end',10.0,'dt',2e-3,'verbose',true, ...
            'plot_results',true,'plot_visible',false, ...
            'ibr_events',struct('enabled',false), ...
            'ieee14_index_mode','agsi_pp', ...
            'ieee14_sg_trip_time',1.0,'ieee14_sg_reclose_time',4.0);
        r(end+1,1) = item('ieee14_switch', ...
            'IEEE 14-bus: 1 SG + 4 GFL IBRs - AGSI++ GFL<->GFM switch (SG trip/reclose, stable)', ...
            @cases.case_ibr_ieee14_switch, ieee14_opt, analysis_id);
    otherwise
