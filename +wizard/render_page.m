...
content = uipanel('Parent', panel, 'Units', 'normalized', ...
    'Position', [0.02 0.08 0.96 0.80], 'BorderType', 'none');
...
function value = enable_state(tf)
% Classic uicontrol Enable accepts on/off, not string(logical) -> "1"/"0".
if tf
    value = 'on';
else
    value = 'off';
