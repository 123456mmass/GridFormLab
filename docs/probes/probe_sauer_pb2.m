...
% Fix delta_1 (state 3) and Vre_1 (y(1)) and Vim_1 (y(2)) for slack bus
...
lam=r.eigenvalues;
fprintf('maxreal=%.4f cond(Jyy)=%.3e\n', max(real(lam)), cond(r.Jyy(free_y,free_y)));
