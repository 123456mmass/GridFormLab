...
\author{Mr. Phichitchai Jueajan\quad 66010569\\Mr. Pakkapol Phdungdan\quad 66010612\\[0.2cm]
...
\end{block}
\begin{itemize}
  \item SG1: synchronous reference
  \item IBR1--IBR4: dual-mode converters
\end{itemize}
\column{0.75\textwidth}
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.04\linewidth]{figures/123313.png}}
\end{columns}
\end{frame}
