...
\scriptsize
\renewcommand{\arraystretch}{1.12}\setlength{\tabcolsep}{3pt}
\begin{columns}[t,onlytextwidth]
\column{.49\textwidth}
\textbf{Electrical and network}\\[.05cm]
\begin{tabular}{@{}p{1.85cm}p{3.05cm}@{}}
...
\end{columns}
\medskip\scriptsize
$x$: machine and converter states; $y$: bus voltages; $u$: references, loads and events.\par
$g=0$: Kirchhoff's current balance at every bus, in both PF and TS.\par
$m_i$: controller mode of IBR $i$; both modes share the same electrical plant.\par
\end{frame}
