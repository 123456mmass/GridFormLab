...
\column{.43\textwidth}
\begin{figure}\includegraphics[width=\linewidth,trim=0 0 0 2mm,clip]{figures/xxxx.png}\caption{IBR model.}\label{fig:plant}\end{figure}
...
\centering
\begin{figure}\includegraphics[width=.68\linewidth]{figures/ieee14_scenario_suite/sg_fault_cycle160_agsi3d.png}\caption{Severity index $S_i$ .}\end{figure}

\vspace{1mm}
\begin{figure}\includegraphics[width=.68\linewidth]{figures/ieee14_scenario_suite/sg_fault_cycle160_mode3d.png}\caption{ $m_i$  GFL = 0, GFM = 1.}\end{figure}
\end{frame}
...
\centering\begin{figure}\includegraphics[width=\linewidth,height=5.9cm,keepaspectratio]{figures/ieee14_scenario_suite/sg_fault_cycle160_vf.png}\caption{$(a)$ bus-voltage magnitude and $(b)$ converter frequency.}\end{figure}
\end{frame}
\begin{frame}{Result: Active and Reactive Power}
\centering\begin{figure}\includegraphics[width=\linewidth,height=5.9cm,keepaspectratio]{figures/ieee14_scenario_suite/sg_fault_cycle160_pq_mode.png}\caption{ $(a)$ active power and $(b)$ reactive power.}\end{figure}
\end{frame}
\begin{frame}{Fault Bus  Voltage and Frequency}
\centering\begin{figure}\includegraphics[width=\linewidth,height=5.75cm,keepaspectratio]{figures/ieee14_scenario_suite/sg_fault_cycle160_cmp_vf.png}\caption{ $(a)$ voltage magnitude and $(b)$ frequency.}\end{figure}
\end{frame}
\begin{frame}{Fault Bus Active and Reactive Power}
\centering\begin{figure}\includegraphics[width=\linewidth,height=5.75cm,keepaspectratio]{figures/ieee14_scenario_suite/sg_fault_cycle160_cmp_pq.png}\caption{ $(a)$ active power and $(b)$ reactive power.}\end{figure}
\end{frame}
...
\large{Power System Dynamics, Stability, and Control (PSDSC) Research Center}\\[0.6cm]
\includegraphics[width=3.0cm]{qr_pgaz_lab.png}
\vfill
\end{frame}
\end{document}
