...
$I_{dc}$ (ดัชนี 17 ของ~\eqref{eq:ibrstate} ดูการอนุมานวงจรที่ย่อหน้าแถว~(3)
...
\emph{ขณะที่ตัวแปลงจ่ายกำลังออก} ความต้านทานภายในจึงเป็นขอบเขตด้วยตัวมันเอง และที่จุด
ที่สั่งไว้ $E_{dc}=1.0453\pu$ อยู่ต่ำกว่าขีดเริ่มนำกระแสของชอปเปอร์ $V_{dc}^{\max}=1.10\pu$

\emph{สมมติฐาน $P_{ac}\ge0$ ไม่ใช่ส่วนเกิน และมีแขนหนึ่งที่หลุดจากมัน} ขอบเขตข้างต้น
ไม่ได้บอกอะไรเลยเมื่อ $P_{ac}<0$ ตัวแปลงที่ถูกผลักให้\emph{ดูดกำลัง} --- ถูกตรึงไว้ที่
ขีดจำกัดกระแสขณะที่แรงดันและมุมของเกาะวิ่งหนีจากมัน --- เปลี่ยนพจน์ภาระให้เป็นพจน์
\emph{อัดประจุ} $+|P_{ac}|/V_{dc}$ ดังนั้น $V_{dc}$ จึงไต่ผ่าน $E_{dc}$ ขึ้นไปถึงชอปเปอร์ได้
...
\paragraph{ทำไมค่าการมีส่วนร่วมของ DC ยังเป็น $1.000$ และทำไมมันเป็นข้อเท็จจริง
คนละเรื่องแล้ว}
รายงานฉบับก่อนหน้านี้พิมพ์สี่แถวที่ $\lambda=-10.000000$ เท่ากันทั้งสี่แถว แต่ละแถว
มีค่าการมีส่วนร่วม $1.000$ พอดีบนแรงดันบัส DC ที่นั่นมีคุณสมบัติสองอย่างถูกรวมปนกัน
และมีเพียงอย่างเดียวที่เปลี่ยนไป

ค่าลักษณะเฉพาะที่\emph{ซ้ำกัน}คือลายเซ็นของ closure อุดมคติ มันทำให้แถว DC ถูกแยก
ออกโดยสมบูรณ์ ดังนั้น $-1/T_{dc}$ จึงเป็นค่าลักษณะเฉพาะที่มีพหุคูณเชิงพีชคณิตเท่าสี่
ไม่ว่าตัวแปลงจะทำอะไรอยู่ และ $V_{dc}$ คงที่ตลอดวิถี สิ่งนั้นหายไปแล้ว แถว DC ทั้งสี่
เป็นเลขสี่ค่าที่ต่างกัน เรียงตามกำลังที่แต่ละลิงก์รับ ตรงตามที่สมการทำนาย และ $V_{dc}$
ขยับเป็นพิสัยไม่กี่เปอร์เซ็นต์บนทุกแขน นั่นคือข้อเท็จจริงที่บอกว่าลิงก์มีชีวิต

ค่าการมีส่วนร่วม $1.000$ \emph{ไม่ใช่}หนึ่งในข้อเท็จจริงนั้น และไม่เคยเป็นหลักฐาน
เกี่ยวกับ closure เลย มันเป็นผลของการที่การต่อกันเป็น\emph{ทางเดียว} ซึ่งวัดได้และ
วัดแล้ว: การรบกวน $V_{dc}$ ไม่เปลี่ยนอนุพันธ์ของสเตตอื่นเลยแม้แต่ตัวเดียว
\begin{equation}
  \max_{i\neq V_{dc}}\left|\frac{\partial f_i}{\partial V_{dc}}\right| = 0
  \quad\text{พอดี ทั้งสองสาขา}
  \label{eq:oneway}
\end{equation}
ขณะที่แถว DC อ่านสเตตด้าน AC จริง โดย
$\max_j|\partial f_{V_{dc}}/\partial x_j|=17.65$ จาโคเบียนของอุปกรณ์จึงเป็นบล็อก
สามเหลี่ยมในการแบ่ง (AC, DC) ทำให้เวกเตอร์ลักษณะเฉพาะ\emph{ขวา}ของโมด DC เป็นเวกเตอร์
หนึ่งหน่วยบนพิกัดนั้นพอดี และตัวประกอบการมีส่วนร่วม
$p_{ki}=|\phi_{ik}\psi_{ki}|$ จึงกระจุกอยู่ที่นั่นในเชิงพีชคณิต ไม่ว่าแหล่งจ่าย DC
จะเป็นแบบใด ผู้อ่านควรอ่าน $1.000$ ในคอลัมน์นั้นว่า ``ไม่มีสิ่งอื่นขับพิกัดนี้''
ไม่ใช่ ``พิกัดนี้ไม่ทำอะไรเลย''
