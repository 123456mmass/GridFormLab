...
ts_options.stepper = 'fixed';   % Production default is FIXED-step (canonical). stepper='adaptive' is an explicit production candidate.
ts_options.corrector_mode = 'adaptive';
ts_options.corrector_abs_tol = 1e-10;
ts_options.corrector_rel_tol = 1e-8;
ts_options.max_corrector_iter = 20;
