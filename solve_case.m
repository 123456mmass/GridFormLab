...
opt=struct('t_end',15.0,'dt',0.01,'verbose',false, ...
    ...
    'ibr_events',struct('enabled',true,'fault_bus',4,'Zf',1i*0.1, ...
        'fault_on',1.0,'fault_clear',1.1,'sg_trip',2.0,'sg_on',3.0, ...
...
message=''; nums=cellfun(@str2double,a([1 2 6 7 11:17 19:21]));
...
% IBR_DIALOG_DELAY_DEFAULTS keeps the dialog on the production delay ABI.
