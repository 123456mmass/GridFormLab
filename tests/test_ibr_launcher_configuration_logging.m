...
% This is an explicit legacy transaction-regression fixture.  The interactive
% and default launcher route is now RMS10 Profile B; this test retains the
% historical WECC event oracle without redefining the new model's LVRT scope.
run_opt=struct('ibr_profile','legacy','initial_gfm_count',0, ...
    'initial_gfl_count',4,'initial_gfm_indices',[], ...
    'initial_reference_resource_index',[],'t_end',.1,'dt',.01, ...
    'plot_results',false,'ibr_events',ev);
