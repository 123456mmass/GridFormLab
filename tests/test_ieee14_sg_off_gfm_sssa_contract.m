...
testCase.verifyEqual(s.nx_total,86,'AbsTol',0);
testCase.verifyEqual(s.nx_active,34,'AbsTol',0);
testCase.verifyEqual(size(s.fx),[86 86],'AbsTol',0);
testCase.verifyEqual(size(s.fy),[86 28],'AbsTol',0);
testCase.verifyEqual(size(s.gx),[28 86],'AbsTol',0);
testCase.verifyEqual(size(s.gy),[28 28],'AbsTol',0);
testCase.verifyEqual(size(s.A_full),[86 86],'AbsTol',0);
testCase.verifyEqual(size(s.A),[34 34],'AbsTol',0);
testCase.verifyEqual(numel(s.eigenvalues),34,'AbsTol',0);
